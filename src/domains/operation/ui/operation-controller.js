...
import { recordActivity, synchronizeActiveDeliverables } from '../domain/commands.js';
import {
...
function openWorkflowModal(workflowId = null) {
  ...
  `, form => {
    ...
    if (workflow) {
      ...
      syncedDeliverables = synchronizeActiveDeliverables(state, workflow, () => uid('s'), () => new Date().toISOString());
    } else {
